...
process search_dd_fft_acc {
    ...
    prepsubband -ncpus $task.cpus -lodm ${dm_values[0]} -dmstep ${dm_values[2]} -numdms ${dm_values[3]} -zerodm -nsub \$nsub \
-numout ${obs_length*10000} -downsample ${dm_values[5]} -o ${name} ${params.obsid}_*.fits
