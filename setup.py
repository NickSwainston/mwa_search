...
setup(name="mwa_search",
      ...
      scripts=['scripts/check_known_pulsars.py', 'scripts/cold_storage_mover.py',
               ...
               'scripts/bestgridpos.py', 'scripts/data_processing_pipeline.py',
               ...
               'dpp/yaml_helper.py', 'dpp/prepfold_cmd_make.py',
               'dpp/pulsar_obs_helper.py', 'dpp/dpp_check_args.py', 'dpp/misc_helper.py', 'dpp/upload_and_move.py',
               'version.py',
